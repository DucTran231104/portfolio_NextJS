        ...
        <Card>
          ...
          <CardContent>
            <div className="text-base lg:text-lg space-y-4">
              ...
              <p className="mb-4">This Refund Policy applies to purchases and services made through localhost:3000 and fiaz.dev (Fiaz Technologies) and to any related offerings or services provided by Tran Thai Trong Duc personally or by Fiaz Technologies. References to &quot;we&quot;, &quot;us&quot;, or &quot;our&quot; include both Tran Thai Trong Duc and Fiaz Technologies where applicable.</p>
              ...
              <p className="mb-2 text-sm">This Policy covers paid services, deposits, and fees charged for project work, consulting, and digital goods sold directly by Fiaz Technologies via localhost:3000 and fiaz.dev.</p>
              ...
              <p className="mb-2 text-sm">To request a refund, please do the following:
                <ol className="list-decimal list-inside ml-5 mt-2">
                  <li>Identify where you purchased the service (localhost:3000 or
                    fiaz.dev) and include an invoice/order number or proof of
                    payment.</li>
                  <li>Email <a className="underline text-primary" href="mailto:refund@localhost:3000">refund@localhost:3000</a> (for purchases on
                    localhost:3000) or <a className="underline text-primary" href="mailto:refund@fiaz.dev">refund@fiaz.dev</a> (for purchases on
              ...
              <p className="mb-2 text-sm">For refund requests or questions: <a className="underline text-primary" href="mailto:refund@localhost:3000">refund@localhost:3000</a> (for purchases made via localhost:3000), <a className="underline text-primary" href="mailto:s.muhammadfiaz2003@gmail.com">s.muhammadfiaz2003@gmail.com</a> (personal), or <a className="underline text-primary" href="mailto:refund@fiaz.dev">refund@fiaz.dev</a> (for purchases made via fiaz.dev). General inquiries: <a className="underline text-primary" href="mailto:contact@localhost:3000">contact@localhost:3000</a> or <a className="underline text-primary" href="mailto:contactus@fiaz.dev">contactus@fiaz.dev</a>.</p>
