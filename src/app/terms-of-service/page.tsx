        ...
        <Card>
          ...
          <CardContent>
            <div className="text-base lg:text-lg space-y-4">
              ...
              <p className="mb-4">These Terms of Service (&quot;Terms&quot;) govern your access to and use of localhost:3000 and duc.dev (the &quot;Sites&quot;), owned and operated by Fiaz Technologies (&quot;we&quot;, &quot;us&quot;). By accessing or using the Sites or purchasing services you agree to be bound by these Terms and any separate agreement you enter into with us.</p>
              <p className="mb-4 text-sm">These Terms also apply to any other websites, domains, applications, services, products, or digital properties owned, operated, or offered by Tran Thai Trong Duc (personally) or Fiaz Technologies. References to &quot;we&quot;, &quot;us&quot;, or &quot;our&quot; include both Tran Thai Trong Duc and Fiaz Technologies where applicable.</p>
              ...
              <p className="mb-2 text-sm">As stated in our <a className="underline text-primary" href="/refund-policy">Refund Policy</a>, we generally do not offer refunds. If you believe you are entitled to a refund due to a billing error, duplicate charge, or as required by law, follow the procedure in the Refund Policy. Refund requests can be emailed to <a className="underline text-primary" href="mailto:refund@localhost:3000">refund@localhost:3000</a> (personal) or <a className="underline text-primary" href="mailto:refund@duc.dev">refund@duc.dev</a> (Fiaz Technologies), depending on where the purchase was made.</p>
              ...
              <p className="mb-2 text-sm">For questions about these Terms or to serve legal notices: <a className="underline text-primary" href="mailto:contact@localhost:3000">contact@localhost:3000</a> (personal), <a className="underline text-primary" href="mailto:s.muhammadfiaz2003@gmail.com">s.muhammadfiaz2003@gmail.com</a> (personal), or <a className="underline text-primary" href="mailto:contactus@duc.dev">contactus@duc.dev</a> (Fiaz Technologies). For legal notices: <a className="underline text-primary" href="mailto:legal@duc.dev">legal@duc.dev</a>. For refund enquiries: <a className="underline text-primary" href="mailto:refund@localhost:3000">refund@localhost:3000</a> or <a className="underline text-primary" href="mailto:refund@duc.dev">refund@duc.dev</a> depending on where you purchased the service.</p>
