        ...
        <Card>
          ...
          <CardContent>
            <div className="text-base lg:text-lg space-y-4">
              ...
              <p className="mb-4">
                This Privacy Policy describes how localhost:3000 and duc.dev
              ...
              <p className="mb-4 text-sm">
                This Policy also applies to localhost:3000, duc.dev and any
                other websites, domains, applications, services, products, or
                digital properties owned, operated, or offered by Tran Thai Trong Duc
                (personally) or Fiaz Technologies. For clarity, references to
                &quot;we&quot;, &quot;us&quot; or &quot;our&quot; in this Policy include both
                Tran Thai Trong Duc and Fiaz Technologies where applicable.
              </p>
              ...
              <p className="mb-2 text-sm">We use industry-standard security measures (encryption in transit via HTTPS, access controls, and secure hosting) to protect personal data. We regularly review our security practices but cannot guarantee that unauthorized access, hacking, or data loss will never occur. Report suspected breaches to contact@localhost:3000 immediately.</p>

              <h4 id="rights" className="mt-4 font-semibold">Your Rights</h4>
              <p className="mb-2 text-sm">You may have rights under applicable data protection laws including to access, correct, update, or delete your personal data. Subject to verification and applicable exceptions, you may also have rights to restrict or object to processing and to request portability of your data. To exercise your rights, send a request to contact@localhost:3000. We may ask for information to verify your identity before fulfilling requests.</p>
              ...
              <p className="mb-2 text-sm">For privacy requests or questions, contact: <a className="underline text-primary" href="mailto:contact@localhost:3000">contact@localhost:3000</a> (personal), <a className="underline text-primary" href="mailto:s.muhammadfiaz2003@gmail.com">s.muhammadfiaz2003@gmail.com</a> (personal), or <a className="underline text-primary" href="mailto:contactus@duc.dev">contactus@duc.dev</a> (Fiaz Technologies). For legal requests, contact <a className="underline text-primary" href="mailto:legal@duc.dev">legal@duc.dev</a>. For privacy-related disputes, please include sufficient information to identify your request and allow us to respond promptly.</p>
